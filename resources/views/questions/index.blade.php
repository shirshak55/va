        ...
        <div class="row w-100">
            <div class="col-md-4">
                <div class="card border-info mx-sm-1 p-3">
                    <div class="text-info text-center mt-3"><h4>Questions</h4>
                    </div>
                    <div class="text-info text-center mt-2">
                        <h1>{{$questions_count}}+</h1></div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card border-success mx-sm-1 p-3">
                    <div class="text-success text-center mt-3"><h4>Answers</h4>
                    </div>
                    <div class="text-success text-center mt-2">
                        <h1>{{$answers_count}}+</h1></div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card border-danger mx-sm-1 p-3">
                    <div class="text-danger text-center mt-3"><h4>Views</h4>
                    </div>
                    <div class="text-danger text-center mt-2"><h1>100k+</h1>
                    </div>
                </div>
            </div>
        </div>
